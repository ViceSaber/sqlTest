...
public class CodeGenerator11 {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("D:\\code\\sqlTest\\src\\main\\java");
        globalConfig.setAuthor("zhangqiang");
        //生成后是否打开资源管理器
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/db01?useSSL=false&serverTimezone=GMT%2B8");
        ...
        packageConfig.setParent("com.skura");
